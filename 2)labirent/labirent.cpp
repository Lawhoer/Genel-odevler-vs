...
void kopyalama_ters(char dizi[][100],char a[][100]){
 ...
 int main(){
	...
	textYazdirma(dizi); // txt dosyasýndan labirenti diziye kaydettim
	
	// baslangýc noktasý dizi[5][0]
	// istikamet kodunamevcut index'i ver hangi yöne gitmen gerektiðini söylesin
